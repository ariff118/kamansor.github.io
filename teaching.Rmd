...
**Office Hours:** Monday & Tuesday (9 - 10)  
...
|4. | QMT335      | Introduction to Time Series Forecasting    |  
|5. | QMT339      | Spreadsheet Modeling and Decision Analysis |  
...
Data Collection Methods  
  ...
  - Direct Observation  
  - Questionnaire ( self administered, electronic media)  
  - Others  
</div>
...
1. Measure of central tendency for ungrouped and grouped  
    - Mean  
    - Median  
    - Mode  
</div>  
