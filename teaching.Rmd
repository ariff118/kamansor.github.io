...
|<img src="files/20212/TIMETABLE MARCH2021.jpg" style="width:100%; border:0px solid" align="center">|  

***  

## 20214  

|<img src="files/20214/20214 Timetable.jpg" style="width:100%; border:0px solid" align="center">|  
...
<div class = "col-md-4">
**Remark:**  
All calculation is suggested in **4 decimal places**  
[Slides]()
</div>
</div>
***  
...
<div class = "col-md-6">
**Topic 6: Introduction to Probability**  
...
<div class = "col-md-4">
**Remark:**  
**Submit Group Project Report (Assessment 3)**  
[Slides]()
</div>
</div>
***  
...
![](images/QMT181-Project-CoverPage.jpg)
...
```{r echo=FALSE}
slickR::slickR(
    list.files("./images/Sample Report/QMT181/",full.names = TRUE,pattern = 'jpg'),
    height = 700,
    width = '95%')
```  
...
##### 7 DETAILS OF DATE SUBMISSION  
Please ensure to submit the hardcopy and softcopy (burn in CD) **BEFORE OR ON WEEK 13**  

***  

### Course Assessment {.tabset}  

#### SESI 20192 {.tabset .tabset-dropdown}
...
#### SESI 20212 {.tabset .tabset-dropdown}
...
library(scales)
library(DT)
data_20212_kba1113b <- readxl::read_excel("files/20212/QMT181_KBA1113B.xlsx")

# knitr::kable(data_20212_kba1111e[ , -3], caption = "Continuous Assessment (40%)") 
#  %>%  kable_styling()
datatable(head(data_20212_kba1113b[ , -3], n = nrow(data_20212_kba1113b[ , -3])), options = list(pageLength = 25))
```
...
library(scales)
library(DT)
data_20212_kba1193a <- readxl::read_excel("files/20212/QMT181_KBA1193A.xlsx")

# knitr::kable(data_20212_kba1111e[ , -3], caption = "Continuous Assessment (40%)") 
#  %>%  kable_styling()
datatable(head(data_20212_kba1193a[ , -3], n = nrow(data_20212_kba1193a[ , -3])), options = list(pageLength = 25))
```

#### SESI 20222 {.tabset .tabset-dropdown}  
...
library(scales)
library(DT)
data_20222_kba1193a <- readxl::read_excel("files/20222/CA_QMT181_KBA1193A.xlsx")

# knitr::kable(data_20212_kba1111e[ , -3], caption = "Continuous Assessment (50%)") 
#  %>%  kable_styling()
datatable(head(data_20222_kba1193a[ , -c(3,4,5,6,7)], n = nrow(data_20222_kba1193a[ , -c(3,4,5,6,7)])), options = list(pageLength = 25))
```
...
library(dplyr)
library(scales)
data_kam2281a <- readxl::read_excel("files/20214/MAT402_KAM2281A.xlsx")

knitr::kable(data_kam2281a[ , -c(3,4)], caption = "Continuous Assessment (40%)") 
#  %>%  kable_styling()
```
</details>  
...
``` {r echo = FALSE}
data_summary <- summary(data_kam2281a[,c(5:13)])
knitr::kable(data_summary, caption = "Performance Summary")
```
</details>
